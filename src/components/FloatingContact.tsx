...
// policy), so we inline the official Simple-Icons path rather than pull in
// an extra dependency just for one glyph.
  ...
  return (
    <div className="fixed bottom-24 right-3 z-40 flex flex-col gap-2 sm:bottom-5 sm:right-5">
      <motion.a
        ...
        className="w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-[#25D366] shadow-[0_8px_24px_rgba(37,211,102,0.45)] flex items-center justify-center text-white"
      >
