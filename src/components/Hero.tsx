...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-between overflow-hidden px-4 pb-0">
      ...
      {/* Orbs */}
      <div className="absolute top-1/4 -left-20 w-64 h-64 rounded-full bg-[#1A5FD4]/10 blur-3xl pointer-events-none animate-float" />
      <div className="absolute bottom-1/3 -right-20 w-80 h-80 rounded-full bg-[#0D3D8E]/15 blur-3xl pointer-events-none animate-float" style={{ animationDelay: "1.5s" }} />
      ...
      <div className="relative z-10 w-full max-w-4xl mx-auto text-center pt-24 pb-16">
        ...
        >
          <div className="relative w-24 h-24 sm:w-32 sm:h-32 rounded-full overflow-hidden ring-4 ring-[#1A5FD4]/30 shadow-[0_0_60px_rgba(26,95,212,0.4)]">
            <Image src="/Logo.png" alt="Klicseo" fill className="object-cover" priority />
          </div>
        </motion.div>
      ...
      <a
        href="#services"
        className="relative z-10 mb-8 flex flex-col items-center gap-1 text-white/30 hover:text-[#C9A84C] transition-colors animate-float"
      >
